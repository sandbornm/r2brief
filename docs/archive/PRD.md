# Product Requirements Document: r2b
...
- **LLM**: Explicit hosted or local provider for optional code interpretation
...
[*] r2b v0.1.0 - Binary Analysis Copilot
...
r2b> can you trace execution from main to the network call?
...
```bash
# Basic usage
r2b <binary>                    # Auto-analyze + REPL
r2b <binary> --batch            # Non-interactive, JSON output
r2b <binary> --quick            # Skip deep analysis

# Direct queries
r2b <binary> --ask "what does this do?"
r2b <binary> --function main --decompile
r2b <binary> --strings --filter "http"

# Export
r2b <binary> --export report.md
r2b <binary> --export-json analysis.json

# Advanced
r2b <binary> --trace-to 0x401890
r2b <binary> --diff <other_binary>
r2b <binary> --patch <modifications.json>
```
