// Headless post-analysis script for r2b.
...
public class R2BHeadless extends GhidraScript {
    ...
    protected void run() throws Exception {
        println("[r2b] R2BHeadless script executing");
        
        if (currentProgram == null) {
            println("[r2b] ERROR: No program loaded");
            return;
        }
        
        String programName = currentProgram.getName();
        println("[r2b] Analyzing: " + programName);
        
        // Output file path - use env var or default location
        String outputPath = System.getenv("R2B_OUTPUT");
        if (outputPath == null || outputPath.isEmpty()) {
            File programFile = getProgramFile();
            if (programFile != null) {
                outputPath = programFile.getParentFile().getAbsolutePath() + 
                             "/" + programName + "_r2b.json";
            } else {
                outputPath = "/tmp/" + programName + "_r2b.json";
            }
        }
        
        println("[r2b] Output: " + outputPath);
        ...
        println("[r2b] Analysis complete. Functions: " + functions.size() +
    ...
    private List<String[]> collectFunctions() throws CancelledException {
        ...
        println("[r2b] Collected " + count + " functions");
        return functions;
    }
    ...
    private List<String[]> collectStrings() throws CancelledException {
        ...
        println("[r2b] Collected " + count + " strings");
        return strings;
    }
    ...
    private List<String[]> decompileFunctions(List<String[]> functions) throws CancelledException {
        ...
        if (!decomp.openProgram(currentProgram)) {
            println("[r2b] WARNING: Could not initialize decompiler");
            return decompiled;
        }
        ...
        for (String[] funcInfo : functions) {
            ...
            try {
                ...
                println("[r2b] Failed to decompile " + name + ": " + e.getMessage());
            }
        }
        
        decomp.dispose();
        println("[r2b] Decompiled " + count + " functions");
        return decompiled;
    }
    ...
    private void writeJsonOutput(String outputPath, List<String[]> functions, 
        ...
        println("[r2b] Wrote JSON to: " + outputPath);
    }
