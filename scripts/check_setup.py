#!/usr/bin/env python3
"""Verify core r2b wiring (env vars, tooling, web app bootstrap)."""
...
from r2b.state import build_state  # noqa: E402
from r2b.web.app import create_app  # noqa: E402
