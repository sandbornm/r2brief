"""Debug logging module for r2b backend.
...
DEBUG_ENABLED = (
    os.environ.get("R2B_DEBUG") or os.environ.get("R2B_DEBUG", "false")
).lower() in ("true", "1", "yes", "on")

# Configure logging
logger = logging.getLogger("r2b.debug")
...
class DebugLogger:
    ...
    def enable(self) -> None:
        ...
        DEBUG_ENABLED = True
        self.enabled = True
        logger.info(colored("[r2b] Debug mode ENABLED", "green"))
    ...
    def disable(self) -> None:
        ...
        DEBUG_ENABLED = False
        self.enabled = False
        logger.info(colored("[r2b] Debug mode DISABLED", "red"))
