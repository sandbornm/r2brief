"""Shared pytest fixtures for r2b tests."""
...
from r2b.config import AppConfig, AnalysisSettings, LLMSettings, StorageSettings
from r2b.environment.detectors import EnvironmentReport, ToolCheck
from r2b.storage import ChatDAO, Database
from r2b.analysis.resource_tree import BinaryResource, FunctionResource
