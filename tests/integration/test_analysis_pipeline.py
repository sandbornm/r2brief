...
from r2b.config import AppConfig, AnalysisSettings
from r2b.environment.detectors import EnvironmentReport, ToolCheck
from r2b.analysis.orchestrator import AnalysisOrchestrator, AnalysisPlan
...
class TestAnalysisOrchestrator:
    ...
    def test_non_elf_firmware_routes_away_from_elf_only_deep_scans(self, minimal_config, mock_env, tmp_path):
        ...
        assert result.analysis_graph["schema_version"] == "r2b.analysis_graph.v1"
