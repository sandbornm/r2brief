...
from r2b.llm.manager import LLMBridge
from r2b.llm.ollama_client import list_ollama_models, select_ollama_model
...
def test_ollama_model_selection_prefers_installed_gemma(monkeypatch):
    ...
    monkeypatch.setattr("r2b.llm.ollama_client.httpx.get", fake_get)
