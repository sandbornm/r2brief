...
from r2b.pilot import PilotEngine, build_cmd, corpus_context, extract_json, pilot_dir_for, validate_plan
...
def test_build_cmd_analyze_and_brief(lab_root, monkeypatch):
    monkeypatch.setenv("R2B_PILOT_BIN", "r2b")
    ...
    assert analyze == [
        "r2b", "analyze", str(lab_root / "work/c7/rootfs/usr/sbin/httpd"),
